...
class AutomationItem(ReapyObject):
    ...
    def set_value(self, time, angle):
        RPR.SetEnvelopePointEx(self.envelope_id, self.index, 0, 0, angle, 7, 0, True, False)
        # RPR_SetEnvelopePointEx(envelope, autoitem_idx, ptidx, timeInOptional, valueInOptional, shapeInOptional, tensionInOptional, selectedInOptional, noSortInOptional)
